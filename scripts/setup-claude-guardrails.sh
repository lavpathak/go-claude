...
REQUIRED=(
    ...
    ".claude/skills/go-interfaces/SKILL.md"
    ".claude/skills/go-project-structure/SKILL.md"
    ".claude/skills/go-concurrency/SKILL.md"
    ".claude/skills/go-solid-patterns/SKILL.md"
    ".claude/skills/go-http-handlers/SKILL.md"
    ".claude/skills/go-database/SKILL.md"
    ".claude/skills/go-context/SKILL.md"
    ".claude/skills/go-logging/SKILL.md"
    ".claude/skills/go-configuration/SKILL.md"
